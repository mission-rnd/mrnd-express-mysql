 ...
 * @param connectionString {String} url to connect to the database.
 ...
 */
exports.executeSQL = function(connectionString, sql, params, callback) {
...
exports.createRecordHelper = function(connectionString, table, values, callback) {
    try {
        var insertQuery = exports.createInsertQuery(table, values);
        console.log("insertquery ",insertQuery);
        if(insertQuery) {
            exports.executeSQL(connectionString, insertQuery.sql, insertQuery.params, callback);
        } else {
            //TODO : throw error..
        }
    } catch(e) {
...
exports.GetConnection = function(){
    ...
    var del = theConnection._protocol._delegateError;
    theConnection._protocol._delegateError = function(err, sequence){
        if (err.fatal) {
...
exports.deleteRecordHelper = function(connectionString, table, filters, callback) {
    var deleteQuery = exports.createDeleteQuery(table, filters);
    console.log("deleteQuery ",deleteQuery);
    if(deleteQuery) {
        exports.executeSQL(connectionString, deleteQuery.sql, deleteQuery.params, callback);
    } else {
        //TODO: throw error
    }
}

exports.updateRecordHelper = function(connectionString, table, filters, values, callback) {
    var updateQuery = exports.createUpdateQuery(table, filters, values);
    console.log("updateQuery ",updateQuery);
    if(updateQuery) {
        exports.executeSQL(connectionString, updateQuery.sql, updateQuery.params, callback);
    } else {
        //TODO : throw error..
    }
};

exports.getAllByFilter = function(connectionString, table, filters, callback) {
    var fetchQuery = exports.createFetchQuery(table, filters);
    console.log("fetchquery ",fetchQuery);
    if(fetchQuery) {
        exports.executeSQL(connectionString, fetchQuery.sql, fetchQuery.params, callback);
    } else {
        //TODO : throw error..
    }
};